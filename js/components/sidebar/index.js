  ...
  render() {
    return (
      ...
      >
        ...
        <List>
          <ListItem button iconLeft onPress={() => this.navigateTo('new_collaboration')} >
            <View style={styles.listItemContainer}>
              ...
              <Text style={styles.text}>New Collaboration</Text>
            </View>
          </ListItem>
          <ListItem button iconLeft onPress={() => this.navigateTo('community')} >
            <View style={styles.listItemContainer}>
              <View style={[styles.iconContainer, { backgroundColor: '#0209D8', paddingLeft: 14 }]}>
                <Icon name="ios-phone-portrait-outline" style={styles.sidebarIcon} />
              </View>
          ...
          <ListItem button iconLeft onPress={() => this.navigateTo('create_post')} >
            <View style={styles.listItemContainer}>
              <View style={[styles.iconContainer, { backgroundColor: '#0209D8', paddingLeft: 14 }]}>
                <Icon name="ios-phone-portrait-outline" style={styles.sidebarIcon} />
              </View>
          ...
          <ListItem button iconLeft onPress={() => this.navigateTo('overview')} >
            <View style={styles.listItemContainer}>
              <View style={[styles.iconContainer, { backgroundColor: '#0209D8', paddingLeft: 14 }]}>
                <Icon name="ios-phone-portrait-outline" style={styles.sidebarIcon} />
              </View>
